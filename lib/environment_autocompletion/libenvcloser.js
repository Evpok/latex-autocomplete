...
const to_close = function(line, code_before, code_after){
    ...
    while ((m = begin_re.exec(l)) !== null) {
        ...
        const line_remains = l.slice(begin_re.lastIndex)
...
// Return an array containing the `\end{...}` corresponding to the
