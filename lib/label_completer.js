...
const provider = {
    ...
    getPrefix: function (editor, bufferPosition) {
        ...
        const ref_commands = ['ref', 'cref', 'Cref', 'cpageref', 'Cpageref', 'autoref', 'thref', 'vref', 'vpageref', 'eqref', 'refeq', 'prettyref', 'fref', 'Fref', 'tref', 'pref', 'zref'].join('|')
        // FIXME: Document this!
        const regex = RegExp(String.raw`(\\(?:${ref_commands})){?([^}\s]*)(}?)`)
