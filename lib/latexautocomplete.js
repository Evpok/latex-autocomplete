...
const donothing_completer = require("./utilities/donothing_completer.js")
...
const get_label_completer_provider = () => {
    if (atom.config.get('latex-autocomplete.autocompleteLabels')){
        return label_completer.provider
    }
    return donothing_completer.provider
}
